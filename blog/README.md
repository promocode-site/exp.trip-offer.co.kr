# 블로그 폴더 설명 (exp.trip-offer.co.kr)
...
주소는 `https://exp.trip-offer.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://exp.trip-offer.co.kr/blog/agoda-coupon/ |
...
- 포인트 색: **#1B64DA** (royal) — `blog.css` 맨 위 `--blog-point`
